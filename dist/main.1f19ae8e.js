...
var div = dom.create("<div><strong>hello</strong></div>");
console.log(div);
dom.after(test, div);
var span = dom.create("<div>div标签</div>");
...
var title = dom.attr(test, "title"); //读取test标签的title值

console.log("title:".concat(title));
dom.text(test, "用于测试修改文本内容");
var text = dom.text(test); //读取test标签的文本内容
...
console.log(testDiv);
var test2 = dom.find(".red", testDiv)[0];
console.log(test2);
dom.parent(test);
